...
main: src/main.cpp src/hello.cpp src/fileexplorer.cpp src/plotter.cpp src/texteditor.cpp src/filediff.cpp src/paint.cpp src/calendar.cpp src/csvtool.cpp imgui.so implot.so
